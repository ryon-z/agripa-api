...
// ImportationInfoList 수입 정보
// @Summary 수입 정보 조회
// @Description 수입 정보 조회합니다
// @Tags v2 수출입
// @Accept  json
// @Produce  json
// @Router /v2/trade/importation/line-graph/{std-item-code} [get]
// @Param std-item-code path string true "표준품목코드"
// @Success 200 {object} v2.TradeInfoGraph
func ImportationInfoList(c *gin.Context) {
	...
	c.JSON(http.StatusOK, gin.H{
		"data": modelsV2.GetImportationInfo(stdItemCode, hskPrdlstCodes),
	})
}

// ImportationRecentTop3List 수입 최근 중량 TOP 3 정보
// @Summary 수입 최근 중량 TOP 3 정보 조회
// @Description 수입 최근 중량 TOP 3 정보 조회합니다
// @Tags v2 수출입
// @Accept  json
// @Produce  json
// @Router /v2/trade/importation/recent-top-3 [get]
// @Success 200 {object} v2.TradeRecentTop3
func ImportationRecentTop3List(c *gin.Context) {
	c.JSON(http.StatusOK, gin.H{
		"data": modelsV2.GetTradeRecentTop3("수입"),
	})
}
